...
public class AuthorizationInterceptor  implements HandlerInterceptor {
	...
	private static final String[] IGNORE_URI = {"firstdetail",
			...
			"updatepwd","gaimima","removebook","wybook","kjbook","shbook","jgbook","addbook","enroll","find","deleteuser","users","admindoderupdate","removeorder","lisi","good","adminorder","shoper","jieguobooks","main", "users","login","bookadd","admin","adminlogin","reg"};	
	 /** 
